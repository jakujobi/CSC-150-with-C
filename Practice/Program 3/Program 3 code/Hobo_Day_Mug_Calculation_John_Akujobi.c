...
void printWelcome ()
{
    ...
    printf("It calculates how much beverage can be held in your hemisphere of your Special Hobo Day mug\n");
    printf("\n");
    return;
}
...
{
    float diameter;
    printf("Type in the diameter of your Hobo Day Mug and press Enter --->:");
    scanf("%f", &diameter);
    return diameter;
}
