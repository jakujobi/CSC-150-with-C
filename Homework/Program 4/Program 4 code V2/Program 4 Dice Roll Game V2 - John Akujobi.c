...
//BUD#2: Logic bug
    //There is no need for the PressEnter function to reset the time seed for the random number generator
//Fixed BUG#2: Seeded the rand function by placing the srand (time (NULL)); in the main function instead of the dice roll function 
            // by removing the PressEnter function from the main function
            // And 
